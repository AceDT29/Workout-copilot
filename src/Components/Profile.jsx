    ...
    <section className="w-full max-w-4xl mx-auto p-4">
      <article className="flex flex-col md:flex-row gap-6">
        <div className="w-full md:w-1/3 flex flex-col items-center gap-4">
          ...
          <h2 className="text-xl font-medium">{name ? 'chea' : 'No display name'}</h2>
          ...
          <div className="w-full flex flex-col gap-2 mt-4">
            ...
            <button className="w-full px-4 py-2 rounded text-white shadow-lg border bg-red-500/60 hover:bg-red-500 transition duration-500">Delete profile</button>
          </div>
        </div>
        <div className="w-full md:w-2/3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">
                    {name ? "Chea" : <button className='profileSetters'>Añade un nombre</button>} 
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">chea@gmail.com</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`w-full p-4 rounded-md shadow bg-white`}>
            ...
            <div className="border border-dashed border-slate-200 rounded p-6 text-center">
              <p className="text-sm mb-3">You don't have any routines yet.</p>
              <button className="px-4 py-2 rounded bg-blue-600 text-white">Create your first routine</button>
            </div>
          </div>
        </div>
      </article>
